        ...
        <div className="container mt-5">
            ...
            <form onSubmit={handleSubmit} className="card p-4 shadow mx-auto" style={{ maxWidth: "500px" }}>
                ...
                <div className="mb-3">
                    ...
                    <input name="event_date" type="date" className="form-control" value={form.event_date} onChange={handleChange} required/>
                </div>

                <div className="mb-3">
                    <label className="form-label">Horario</label>
                    <input name="schedule" className="form-control" value={form.schedule} onChange={handleChange} required/>
                </div>

                <div className="mb-3">
                    <label className="form-label">Estilos</label>
                    <input name="styles" className="form-control" value={form.styles} onChange={handleChange} required/>
                </div>
                ...
                <div className="mb-3">
                    ...
                    <input name="contact_number" type="number" className="form-control" value={form.contact_number} onChange={handleChange} required/>
                </div>

                <div className="mb-3">
                    <label className="form-label">Nombre del Dueño</label>
                    <input name="owner_name" className="form-control" value={form.owner_name} onChange={handleChange} required/>
                </div>
