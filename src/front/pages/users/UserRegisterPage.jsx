					...
					<div className="card shadow border-0">
						<div className="card-body p-4">
							...
							<form onSubmit={handleSubmit}>
								...
								<input className="form-control mb-3" name="surname" placeholder="Apellido" value={form.surname} onChange={handleChange} required/>
								<input type="date" className="form-control mb-3" name="birthdate" value={form.birthdate} onChange={handleChange} required/>
								...
								<div className="form-check mb-3">
									<input type="checkbox" className="form-check-input" name="is_professional_dancer" checked={form.is_professional_dancer} onChange={handleChange} id="isProfessional"/>
